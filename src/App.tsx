  ...
  return (
    <div className="min-h-screen bg-slate-100 flex justify-center text-slate-900 selection:bg-slate-200">
      ...
      >
        ...
        <main
          className="flex-1 px-4 md:px-6 relative"
          style={{ paddingTop: '7rem', touchAction: 'pan-y', overscrollBehaviorY: 'contain' }}
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center bg-slate-950/35 p-4" dir="rtl">
            <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl">
              ...
              <div className="mt-5 flex gap-2">
                <button type="button" onClick={handleUpdateNow} disabled={isDownloadingUpdate} className="flex-1 rounded-xl bg-blue-600 px-3 py-2.5 text-sm font-semibold text-white disabled:opacity-60">
                  {isDownloadingUpdate ? 'جاري التحميل...' : 'تحديث الآن'}
                </button>
